...
$.getJSON("http://localhost/Web%20service/api/product/read_one.php?id=" + id, function(data){
    ...
    var category_name = data.category_name;
     //window.alert("Calling category/read.php");
   // load list of categories
$.getJSON("http://localhost/Web%20service/api/category/read.php", function(data){
	//window.alert("After category/read.php");
...
$.ajax({
    url: "http://localhost/Web%20service/api/product/update.php",
    type : "POST",
